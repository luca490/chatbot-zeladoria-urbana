...
Pontos de referência conhecidos em Diadema (como "Praça da Moça", "Shopping Praça da Moça", "Fatec Luigi Papaiz", "Fatec Diadema", parques, praças ou prédios públicos) são considerados localizações válidas e suficientes; não exija rua ou número nesses casos.
